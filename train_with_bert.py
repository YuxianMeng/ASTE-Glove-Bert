...
from bert_data_utils0 import ABSADatasetReader
...
class Instructor:
    def __init__(self, opt):
        ...
        self.absa_dataset = ABSADatasetReader(dataset=opt.dataset, embed_dim=opt.embed_dim, opt=opt)
        ...
        self.model = opt.model_class(opt).to(opt.device)#opt.model_class(absa_dataset.embedding_matrix, opt).to(opt.device)
    ...
    def _train(self, criterion, optimizer):
        ...
        for epoch in (range(self.opt.num_epoch)):
            ...
            print('test: p-pair-sentiment: {:.4f}, r-pair-sentiment: {:.4f}\n'\
...
if __name__ == '__main__':
    ...
    input_colses = {
        'bert': ['text_indices', 'mask', 'aspect_sequence_labels', 'opinion_sequence_labels', 'pair_grid_labels', 'triple_grid_labels']
    }
    initializers = {
