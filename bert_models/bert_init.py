...
class BERT_GCN(nn.Module):
    def __init__(self, opt, pretrained_model='bert-base-uncased'):
        ...
        # for i in self.bert_model.parameters():
        #     i.requires_grad = False

        self.text_embed_dropout = nn.Dropout(0.5)
        self.pairgeneration = PairGeneration0(768)
        # new classifier 
        self.aspect_opinion_classifier = SequenceLabelForAO(768, 3, 0.5)
